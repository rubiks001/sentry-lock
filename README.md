...
git clone https://github.com/yourusername/SentryLock.git
Open SentryLock.ino in the Arduino IDE.
Connect the hardware as shown in the pin configuration table.
Upload the sketch to your Arduino board.
Open Serial Monitor at 9600 baud to watch live readings.
📐 Circuit Diagram
(Coming soon)
🔭 Planned Features
